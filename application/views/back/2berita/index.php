                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTable" width="100%"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="<?php echo base_url('back_assets/upload/image/thumbs/' . $berita->gambar) ?>"
                                            class="img img-responsive" width="60">
                                    </td>
                                    ...
                                    <td class="d-flex justify-content-center">
                                        <a href="<?php echo base_url('admin/berita/edit/' . $berita->id_berita) ?>"
                                            class="btn btn-primary btn-sm mr-1"><i class="fa fa-edit"></i> Ubah</a>
