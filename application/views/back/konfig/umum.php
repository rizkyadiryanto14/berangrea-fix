                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="icon-tab" data-toggle="tab" href="#icon" role="tab"
                                aria-controls="icon" aria-selected="false">Favicon</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="background-tab" data-toggle="tab" href="#background" role="tab"
                                aria-controls="background" aria-selected="false">Backgroud</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="ucapan-tab" data-toggle="tab" href="#ucapan" role="tab"
                                aria-controls="ucapan" aria-selected="false">Ucapan</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="card-body">
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="umum" role="tabpanel" aria-labelledby="umum-tab">
                            <form action="<?php echo site_url('admin/konfig') ?>" method="post">
                                <input type="hidden" name="id_konfigurasi"
                                    value="<?php echo $site['id_konfigurasi'] ?>">
                                <div class="row mb-3">
                                    <div class="col-md-6 order-md-1">
                                        <h3>Informasi Dasar</h3>
                                        <div class="form-group">
                                            <label>Nama Situs</label>
                                            <input type="text" name="namaweb" placeholder="Nama Situs"
                                                value="<?php echo $site['namaweb'] ?>" required class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>Nama Desa</label>
                                            <input type="text" name="tagline" placeholder="Nama Desa"
                                                value="<?php echo $site['tagline'] ?>" required class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>Keterangan situs</label>
                                            <textarea name="tentang" rows="3" class="form-control"
                                                placeholder="Keterangan Situs"><?php echo $site['tentang'] ?></textarea>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="alamat" rows="3" class="form-control"
                                                placeholder="Alamat lengkap"><?php echo $site['alamat'] ?></textarea>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="hp" placeholder="+628-00000-0000"
                        ...
                        <div class="tab-pane fade" id="logo" role="tabpanel" aria-labelledby="logo-tab">
                            ...
                            <form action="<?php echo site_url('admin/konfig/logo') ?>" method="post"
                                ...
                                <div class="form-group col-md-12 mb-4">
                                    ...
                                    <img src="<?php echo base_url('back_assets/img/' . $site['logo']) ?>"
                        ...
                        <div class="tab-pane fade" id="icon" role="tabpanel" aria-labelledby="icon-tab">
                            ...
                            <form action="<?php echo site_url('admin/konfig/icon') ?>" method="post"
                                ...
                                <div class="col-md-12 mb-4">
                                    ...
                                    <img src="<?php echo base_url('back_assets/img/' . $site['icon']) ?>"
                                        style="max-width:200px; height:auto;">
                                </div>
                        ...
                        <div class="tab-pane fade" id="background" role="tabpanel" aria-labelledby="background-tab">
                            ...
                            <form action="<?php echo site_url('admin/konfig/background') ?>" method="post"
                                enctype="multipart/form-data">
                                <input type="hidden" name="id_konfigurasi"
                                    value="<?php echo $site['id_konfigurasi'] ?>">
                                ...
                                <div class="col-md-9 mb-4">
                                    ...
                                    <img src="<?php echo base_url('back_assets/img/' . $site['background']) ?>"
                                        style="max-width:80%; height:auto;">
                                </div>

                                <div class="form-group col-md-12">
                                    <input type="reset" name="reset" value="Reset" class="btn btn-secondary mr-2">
                                    <input type="submit" name="submit" value="Simpan Background"
                                        class="btn btn-primary">
                                </div>
                            </form>
                        </div>
                        <!-- menu keempat -->
                        <script
                            src="https://cdn.tiny.cloud/1/7ko2ftgz9ujgvnh1tq2wbfamm5ztwaieu3mi3b8ayc69fxrh/tinymce/5/tinymce.min.js"
                        ...
                        <div class="tab-pane fade" id="ucapan" role="tabpanel" aria-labelledby="ucapan-tab">
                            <form action="<?php echo site_url('admin/konfig/ucapan') ?>" method="post"
                                enctype="multipart/form-data">
                                <input type="hidden" name="id_konfigurasi"
                                    value="<?php echo $site['id_konfigurasi'] ?>">
                                ...
                                <div class="col-md-12 order-md-1">
                                    <div class="form-group">
                                        <label>Judul</label>
                                        <input type="text" name="welcome_say" placeholder="Judul Ucapan"
                                            value="<?php echo $site['welcome_say'] ?>" required class="form-control">
                                    </div>

                                    <div class="form-group">
                                        <label>Deksripsi</label>
                                        <textarea name="deskripsi_say" id="keterangan" class="form-control" required
                                            placeholder="Deskripsi kalimat sambutan"><?php echo $site['deskripsi_say'] ?></textarea>
                                    </div>
                                </div>
                                <div class="col-md-4 order-md-1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img src="<?php echo base_url('back_assets/img/thumbs/' . $site['foto_sambutan']) ?>"
                                            style="max-width:80%; height:auto;">
                                    </div>
