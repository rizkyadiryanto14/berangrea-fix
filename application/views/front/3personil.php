   ...
   <section class="download-area section-padding">
           ...
           <div class="row">
               ...
               <div class="col-lg-3 col-sm-6">
                   <div class="single-team mb-5 mb-lg-0">
                       <div class="team-img"
                           style="<?php echo "background-image: url('" . base_url('back_assets/upload/pengurus/' . $data4->image) . "');" ?>">
       ...
       <div class="more-job-btn mt-5 text-center">
           <a href="<?php echo site_url('pengurus') ?>" class="template-btn">Selengkapnya<span
