...
<head>
    ...
    <link href="<?php echo base_url('front_assets/css/animate-3.7.0.css') ?>" type="text/css" rel="stylesheet"
        media="all">
    ...
    <header class="header-area main-header smart-scroll p-2 blur-ios border-bawah">
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                    <div class="logo-area">
                        <a href="<?php echo base_url() ?>"><img height="50"
                                src="<?php echo base_url('back_assets/img/' . $site['logo']) ?>" alt="logo"></a>
                    </div>
                </div>
                <div class="col-lg-9">
                    ...
                    <div class="main-menu">
                        <ul>
                            ...
                            <li><a href="<?php echo site_url('surat') ?>">Surat</a></li>
        ...
        <div id="carouselExampleIndicators" class="carousel slide <?php if ($site['slide_setting'] == "Fade") {
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active"
                    style="<?php echo "background-image: url('" . base_url('back_assets/upload/slider/' . $data2->image) . "');" ?>">
