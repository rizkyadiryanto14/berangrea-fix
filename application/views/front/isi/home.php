...
<section id="berita" class="employee-area section-padding">
                    ...
                    <div class="d-sm-flex">
                        <div class="single-news" style="width: 520px;">
                            <a href="<?php echo site_url('berita/read/' . $beritaku->slug_berita) ?>">
                                <div class="news-img"
                                    style="<?php echo "background-image: url('" . base_url('back_assets/upload/image/' . $beritaku->gambar) . "');" ?>">
                                </div>
                            </a>
                            <div class="news-tag">
                                <ul class="my-3">
                                    <li>
                                        <h5><i class="fa fa-calendar-o"></i>
                                            <?php echo date('d M Y', strtotime($beritaku->tanggal_post)) ?></h5>
                                    </li>
                            ...
                            <div class="news-title">
                                <h4><a href="<?php echo site_url('berita/read/' . $beritaku->slug_berita) ?>"><?php echo substr($beritaku->nama_berita, 0, 35) ?><span
                                            class="flaticon-next"></span></a></h4>
                            </div>
                        </div>
                    </div>
                    <?php } ?>
    ...
    <div class="more-job-btn mt-3 text-center">
        <a href="<?php echo site_url('berita') ?>" class="template-btn">Baca Selengkapnya<span
