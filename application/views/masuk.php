        ...
        <div class="mt-5">
            <div class="row">
                <div class="col-12 col-md-6 text-center mt-3 mx-auto p-3">
                    ...
                    <br>
                    <h1 class="h2" style="font-size: 28px;">Sistem Informasi Desa Berangrea</h1>
                ...
                <div class="col-12 col-md-5 mx-auto mt-6">
                    <form action="<?php echo base_url('index.php/auth/login'); ?>" method="POST">
                        <div class="form-group">
                            <input type="text" class="form-control" minlength="4" maxlength="32" name="username"
                                placeholder="Username / Email" required autofocus />
                        </div>
                        <div class="form-group">
                            <input type="password" pattern=".{4,}" minlength="4" maxlength="32"
